...
file4 = File.open('app/assets/images/moon_colony_with_rover.jpg')
file5 = File.open('app/assets/images/moon_guy.jpg')
file6 = File.open('app/assets/images/europa_moon.jpg')
...
moon4.photos.attach(io: file4, filename: 'moon_colony_with_rover.jpg')
moon5.photos.attach(io: file5, filename: 'moon_guy.jpg')
moon6.photos.attach(io: file6, filename: 'europa_moon.jpg')
